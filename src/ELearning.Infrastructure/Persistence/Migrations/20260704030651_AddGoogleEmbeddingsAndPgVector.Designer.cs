...
namespace ELearning.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260704030651_AddGoogleEmbeddingsAndPgVector")]
    partial class AddGoogleEmbeddingsAndPgVector
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ELearning.Domain.Aggregates.AiAggregate.AiQueryEmbeddingCache", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("QueryHash", "Provider", "Model", "Dimensions")
                        .IsUnique();

                    b.ToTable("ai_query_embedding_cache", (string)null);
                });
