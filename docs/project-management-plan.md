---
name: ELearning Plan
overview: Roadmap for a large-scale ELearning system with many entities/sub-entities, .NET Clean Architecture backend (audit/log/repository/mapping) and Angular frontend, plus documentation updates.
todos:
  - id: init-structure
